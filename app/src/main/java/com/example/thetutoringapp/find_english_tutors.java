                    ...
                    if(sentRequest == false) {
                        mFireStore.collection("Requests").add(userMap).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                Toast.makeText(find_english_tutors.TutorViewHolder.super.itemView.getContext(), mAuth.getCurrentUser().getEmail() + " sent a request to: " + list_last.getText().toString(), Toast.LENGTH_SHORT).show();
                                sentRequest = true;
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(find_english_tutors.TutorViewHolder.super.itemView.getContext(), "Cannot send request", Toast.LENGTH_SHORT).show();
